...
class AppColors {
  ...
  static const Color secondaryColor = Color(0xffEDF1F5); // Light Blue
  static const Color secondaryColor1 =Color(0xff66BB6A);// Yellow from AppColors
  static const Color blueGray5001 =  Color(0XFFEDF1F3);
